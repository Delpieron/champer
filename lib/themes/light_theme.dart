...
final ThemeData lightTheme = ThemeData.light(useMaterial3: true).copyWith(
  ...
  textTheme: const TextTheme(
    ...
    headlineMedium: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white, fontFamily: 'ganiser',letterSpacing: 3,),
  ),
);
final ThemeData mobileLightTheme = ThemeData.light(useMaterial3: true).copyWith(
  ...
  textTheme: const TextTheme(
    ...
    headlineMedium: TextStyle(fontSize: 18, fontWeight: FontWeight.w300, color: Colors.white, fontFamily: 'ganiser',letterSpacing: 3,),
  ),
);
